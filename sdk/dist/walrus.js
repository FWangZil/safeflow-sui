...
export async function uploadJsonToWalrus(payload, inputConfig = {}) {
...
export function resolveWalrusClientConfig(inputConfig = {}) {
...
export function buildAggregatorBlobUrl(aggregatorUrl, blobId) {
    return `${removeTrailingSlash(aggregatorUrl)}/v1/blobs/${encodeURIComponent(blobId)}`;
}
export function buildWalrusSiteUrl(blobId, suffix = DEFAULT_WALRUS_SITE_SUFFIX) {
...
function extractBlobId(parsedResponse) {
