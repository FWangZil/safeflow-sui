...
WALRUS_PUBLISHER_URL_DEFAULT="${WALRUS_PUBLISHER_URL:-https://publisher.testnet.walrus.space}"
WALRUS_AGGREGATOR_URL_DEFAULT="${WALRUS_AGGREGATOR_URL:-https://aggregator.testnet.walrus.space}"
